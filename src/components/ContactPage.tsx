  ...
  return (
    <div style={{ background: 'var(--surface)', color: 'var(--ink)', paddingTop: 80 }}>
      ...
      <section ref={heroRef} style={{ position: 'relative', overflow: 'hidden', padding: 'clamp(60px, 10vw, 100px) 0 clamp(60px, 10vw, 120px)', borderBottom: '1px solid var(--line)', textAlign: 'center' }}>
        ...
        {/* Glow orb */}
        <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%,-50%)', width: 900, height: 600, background: 'radial-gradient(ellipse,rgba(245,41,13,0.09) 0%,transparent 65%)', filter: 'blur(80px)', pointerEvents: 'none' }} />
        {/* Rings */}
        <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%,-50%)', width: 700, height: 700, borderRadius: '50%', border: '1px solid rgba(245,41,13,0.05)', pointerEvents: 'none', animation: 'spin-slow 30s linear infinite' }} />
        <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%,-50%)', width: 500, height: 500, borderRadius: '50%', border: '1px solid rgba(245,41,13,0.04)', pointerEvents: 'none', animation: 'spin-slow 20s linear infinite reverse' }} />

        <div className="cb-container" style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 28 }}>
          {/* Live badge */}
          <div className="reveal" style={{ display: 'inline-flex', alignItems: 'center', gap: 10, background: 'rgba(245,41,13,0.08)', border: '1px solid rgba(245,41,13,0.2)', borderRadius: 100, padding: '8px 20px' }}>
            <div style={{ width: 6, height: 6, borderRadius: '50%', background: 'var(--brand)', boxShadow: '0 0 8px #f5290d', animation: 'pulse-glow 2s infinite' }} />
        ...
        <div className="cb-container">
          <div className="reveal cp-contact-form-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1.4fr', gap: 'clamp(32px, 6vw, 80px)', alignItems: 'start' }}>
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 24, marginBottom: 48 }}>
                {[
                  ...
                  <div key={item.label} style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                    <div style={{ width: 44, height: 44, borderRadius: 12, background: 'rgba(245,41,13,0.07)', border: '1px solid rgba(245,41,13,0.13)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                      <div style={{ width: 8, height: 8, borderRadius: '50%', background: 'var(--brand)' }} />
                    </div>
                    <div>
                      <div style={{ fontSize: 10, fontWeight: 700, color: 'var(--faint)', textTransform: 'uppercase' as const, letterSpacing: '0.1em', marginBottom: 3 }}>{item.label}</div>
                      {item.href
              ...
              {/* NDA note */}
              <div style={{ padding: '20px 22px', background: 'rgba(245,41,13,0.04)', border: '1px solid rgba(245,41,13,0.1)', borderRadius: 16, display: 'flex', alignItems: 'flex-start', gap: 14 }}>
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                  <div style={{ marginBottom: 4 }}>
                    <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase' as const, color: 'var(--faint)', marginBottom: 8 }}>Project Enquiry</div>
                  ...
                  {error && <div id="cp-form-error" role="alert" style={{ color: 'var(--brand)', fontSize: 13, fontWeight: 500, background: 'rgba(245,41,13,0.1)', border: '1px solid rgba(245,41,13,0.2)', padding: '12px 16px', borderRadius: 12, marginTop: 4 }}>{error}</div>}

                  <button type="submit" disabled={isLoading} style={{ marginTop: 4, height: 60, borderRadius: 100, border: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12, background: isLoading ? 'rgba(245,41,13,0.5)' : '#f5290d', color: 'var(--ink)', fontSize: 15, fontWeight: 700, cursor: isLoading ? 'not-allowed' : 'pointer', transition: '0.3s', fontFamily: 'inherit' }}
            ...
            {OFFICES.map((o, i) => (
              <div key={o.city}
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
                  ...
                  {o.hq && <span style={{ fontSize: 9, fontWeight: 700, color: 'var(--brand)', background: 'rgba(245,41,13,0.1)', padding: '3px 8px', borderRadius: 100, letterSpacing: '0.08em' }}>HQ</span>}
                </div>
                <p style={{ fontSize: 13, color: 'var(--body)', lineHeight: 1.6, margin: '0 0 12px' }}>{o.address}</p>
                <div style={{ fontSize: 11, fontWeight: 700, color: 'var(--faint)', letterSpacing: '0.1em', textTransform: 'uppercase' as const }}>{o.tz}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <style>{`
        @keyframes pulse-glow {
          0%,100%{opacity:1;box-shadow:0 0 0 0 rgba(245,41,13,0.5);}
          50%{opacity:.7;box-shadow:0 0 0 8px rgba(245,41,13,0);}
        }
        @keyframes spin-slow {
