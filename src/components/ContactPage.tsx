      ...
      <section ref={heroRef} style={{ position: 'relative', overflow: 'hidden', padding: '100px 0 120px', borderBottom: '1px solid rgba(255,255,255,0.07)', textAlign: 'center' }}>
        ...
        <div className="cb-container" style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 28 }}>
          ...
          <div className="reveal" style={{ display: 'inline-flex', alignItems: 'center', gap: 10, background: 'rgba(245,41,13,0.08)', border: '1px solid rgba(245,41,13,0.2)', borderRadius: 100, padding: '8px 20px' }}>
            <div style={{ width: 6, height: 6, borderRadius: '50%', background: '#f5290d', boxShadow: '0 0 8px #f5290d', animation: 'pulse-glow 2s infinite' }} />
            <span style={{ fontSize: 11, fontWeight: 700, color: '#f5290d', letterSpacing: '0.12em', textTransform: 'uppercase' as const }}>Available for New Projects</span>
          </div>
          ...
          <h1 className="reveal reveal-d1" style={{ fontSize: 'clamp(3rem,8vw,8rem)', fontWeight: 500, color: '#fff', letterSpacing: '-0.05em', lineHeight: 0.95, margin: 0, maxWidth: 1000 }}>
            Let&apos;s Build Something<br /><span style={{ color: '#f5290d' }}>Extraordinary.</span>
          </h1>
          ...
          <div className="reveal reveal-d1" style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 20 }}>
            {ENGAGEMENT.map(o => (
              <a key={o.num} href="#contact-form"
                ...
                <span style={{ fontSize: 10, fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase' as const, color: '#f5290d', background: 'rgba(245,41,13,0.1)', padding: '5px 14px', borderRadius: 100, display: 'inline-block', alignSelf: 'flex-start' }}>{o.tag}</span>
                <div>
                ...
                <div style={{ marginTop: 'auto', display: 'inline-flex', alignItems: 'center', gap: 8, color: '#f5290d', fontSize: 13, fontWeight: 700 }}>{o.cta}</div>
              </a>
            ))}
          </div>
        </div>
                ...
                {[
                  ...
                  <div key={item.label} style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                    <div style={{ width: 44, height: 44, borderRadius: 12, background: 'rgba(245,41,13,0.07)', border: '1px solid rgba(245,41,13,0.13)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                      <div style={{ width: 8, height: 8, borderRadius: '50%', background: '#f5290d' }} />
                    </div>
                    <div>
                      ...
                      {item.href
                        ? <a href={item.href} style={{ fontSize: 14, color: '#f5290d', fontWeight: 500, textDecoration: 'none' }}>{item.value}</a>
            ...
            {OFFICES.map((o, i) => (
              <div key={o.city}
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
                  ...
                  {o.hq && <span style={{ fontSize: 9, fontWeight: 700, color: '#f5290d', background: 'rgba(245,41,13,0.1)', padding: '3px 8px', borderRadius: 100, letterSpacing: '0.08em' }}>HQ</span>}
                </div>
      ...
      <section style={{ padding: '120px 0', position: 'relative', overflow: 'hidden', textAlign: 'center' }}>
        ...
        <div className="cb-container" style={{ position: 'relative', zIndex: 1 }}>
          ...
          <h2 style={{ fontSize: 'clamp(2.5rem,5vw,5rem)', fontWeight: 500, color: '#fff', letterSpacing: '-0.04em', lineHeight: 1.0, margin: '0 0 28px' }}>
            Your Next Big Thing<br /><span style={{ color: '#f5290d' }}>Starts Here.</span>
          </h2>
