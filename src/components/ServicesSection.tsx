        ...
        <div className="services-large-grid" style={{ marginBottom: 20 }}>
          {large.map((s, i) => (
            ...
            >
              ...
              {s.href
                ? <Link href={s.href} style={{ display: 'inline-flex', alignItems: 'center', gap: 8, color: '#f5290d', fontSize: 13, fontWeight: 700, letterSpacing: '0.06em', textDecoration: 'none' }}>EXPLORE SERVICE <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M5 12h14M12 5l7 7-7 7" /></svg></Link>
