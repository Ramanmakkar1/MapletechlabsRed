          ...
          {large.map((s, i) => (
            ...
            >
              ...
              {s.href
                ...
                : <div style={{ fontSize: 13, fontWeight: 700, color: 'var(--faint)', letterSpacing: '0.06em' }}>COMING SOON</div>
              }
            </div>
          ))}
        </div>
        ...
        <div className="services-small-grid">
          {small.map((s, i) => (
            ...
            >
              ...
              <span style={{ fontSize: 10, fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--brand)' }}>{s.tag}</span>
              <div>
