        ...
        <div className="cb-container">
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            <div className="nav-desktop" style={{ gap: 12, alignItems: 'center', position: 'relative', zIndex: 2 }}>
              <Link href="tel:+14036048692" style={{ fontSize: 15, fontWeight: 500, color: 'rgba(255,255,255,0.5)', textDecoration: 'none', transition: '0.2s' }}
              ...
              <Link href="/contact" style={{
                ...
                background: 'linear-gradient(135deg, #f5290d, #FF5733)', color: '#fff', fontSize: 15, fontWeight: 700,
                textDecoration: 'none', letterSpacing: '-0.01em', transition: '0.3s',
              }}
                onMouseEnter={e => { e.currentTarget.style.transform = 'translateY(-1px)'; e.currentTarget.style.boxShadow = '0 8px 24px rgba(245,41,13,0.4)'; }}
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(6, 1fr)', gap: 6, marginBottom: 20 }}>
              {serviceCategories.map((cat) => (
                <div key={cat.title} style={{ padding: '14px 14px', borderRadius: 14, border: '1px solid rgba(255,255,255,0.06)', background: 'rgba(255,255,255,0.02)', transition: '0.3s' }}
                  onMouseEnter={e => { e.currentTarget.style.borderColor = 'rgba(245,41,13,0.2)'; e.currentTarget.style.background = 'rgba(245,41,13,0.03)'; }}
            ...
            <div style={{ display: 'flex', gap: 32, paddingTop: 20, borderTop: '1px solid rgba(255,255,255,0.06)', flexWrap: 'wrap' }}>
              {[['500+', 'Projects Shipped'], ['8wk', 'MVP Timeline'], ['100%', 'IP Ownership'], ['NDA', 'Signed on Day 1'], ['24/7', 'Post-Launch Support']].map(([val, label]) => (
                <div key={label} style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  <span style={{ fontSize: 14, fontWeight: 700, color: '#f5290d' }}>{val}</span>
        ...
        >
          <div className="cb-container" style={{ padding: '36px 60px 44px' }}>
            <div style={{ display: 'flex', gap: 80, alignItems: 'flex-start' }}>
              ...
              {/* Featured promo */}
              <div style={{ flex: 1, padding: '28px', borderRadius: 20, border: '1px solid rgba(245,41,13,0.15)', background: 'linear-gradient(135deg, rgba(245,41,13,0.05) 0%, rgba(0,0,0,0) 100%)', position: 'relative', overflow: 'hidden' }}>
        ...
        >
          <div className="cb-container" style={{ padding: '36px 60px 44px' }}>
            <div style={{ display: 'flex', gap: 80 }}>
              <div>
                <div style={{ fontSize: 10, fontWeight: 800, letterSpacing: '0.15em', textTransform: 'uppercase', color: '#f5290d', marginBottom: 6 }}>Mapletech Labs</div>
              ...
              <div style={{ padding: '28px 32px', borderRadius: 20, border: '1px solid rgba(255,255,255,0.08)', background: 'rgba(255,255,255,0.02)', display: 'flex', flexDirection: 'column', gap: 16, minWidth: 280 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  <div style={{ width: 8, height: 8, borderRadius: '50%', background: '#f5290d', boxShadow: '0 0 8px #f5290d' }} />
                  <span style={{ fontSize: 12, fontWeight: 700, color: '#f5290d', letterSpacing: '0.08em', textTransform: 'uppercase' }}>Available for New Projects</span>
                </div>
                ...
                <Link href="#contact" onClick={() => setActiveMenu(null)} style={{ display: 'inline-flex', alignItems: 'center', gap: 8, height: 40, padding: '0 20px', borderRadius: 100, background: 'linear-gradient(135deg, #f5290d, #FF5733)', color: '#000', fontSize: 13, fontWeight: 700, textDecoration: 'none', width: 'fit-content' }}>
                  Book Free Call
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M5 12h14M12 5l7 7-7 7" /></svg>
                </Link>
              </div>
