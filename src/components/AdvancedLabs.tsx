            ...
            <div style={{ borderRadius: 'clamp(24px, 6vw, 48px)', overflow: 'hidden', border: '1px solid rgba(255,255,255,0.08)', background: '#050505', aspectRatio: '4/5', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <div style={{ position: 'relative', zIndex: 2, width: '80%', aspectRatio: '1' }}>
                <svg viewBox="0 0 400 400" style={{ width: '100%', opacity: 0.6 }}>
                  ...
                  <circle cx="200" cy="200" r="110" fill="none" stroke="rgba(245,41,13,0.08)" strokeWidth="1" strokeDasharray="3 6" />
                  {([[200,40],[340,120],[340,280],[200,360],[60,280],[60,120]] as [number,number][]).map(([cx, cy], i) => (
                    <g key={i}>
                      <circle cx={cx} cy={cy} r="8" fill="rgba(245,41,13,0.3)" />
                      <circle cx={cx} cy={cy} r="16" fill="none" stroke="rgba(245,41,13,0.1)" strokeWidth="1" />
                      <line x1={cx} y1={cy} x2="200" y2="200" stroke="rgba(245,41,13,0.06)" strokeWidth="1" />
                    </g>
                  ))}
                  <circle cx="200" cy="200" r="30" fill="rgba(245,41,13,0.1)" />
                  <circle cx="200" cy="200" r="14" fill="#f5290d" opacity="0.4" />
