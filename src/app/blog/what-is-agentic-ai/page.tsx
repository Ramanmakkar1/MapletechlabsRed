...
const a = getArticle('what-is-agentic-ai')!;
const URL = `https://mapletechlabs.ca/blog/what-is-agentic-ai`;
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: canonicalUrl('/blog/what-is-agentic-ai') },
};
...
export default function Page() {
  return (
    <>
      ...
      <BreadcrumbSchema items={getBlogBreadcrumbs(a.title, 'what-is-agentic-ai')} />
