...
const a = getArticle('use-claude-for-free')!;
const URL = `https://mapletechlabs.ca/blog/use-claude-for-free`;
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: canonicalUrl('/blog/use-claude-for-free') },
};
...
export default function Page() {
  return (
    <>
      ...
      <BreadcrumbSchema items={getBlogBreadcrumbs(a.title, 'use-claude-for-free')} />
