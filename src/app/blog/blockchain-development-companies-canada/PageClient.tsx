...
const companies = [
  ...
  { num: 4, name: 'Blockstream', category: 'Bitcoin Infrastructure', emoji: '⛏️', metric: 'Enterprise Bitcoin solutions from Victoria, BC', accentColor: '#34d399', bgColor: 'rgba(52,211,153,' },
  ...
  { num: 8, name: 'Wealthsimple Crypto', category: 'Retail Crypto Access', emoji: '📱', metric: 'Making crypto accessible to everyday Canadians', accentColor: '#4ade80', bgColor: 'rgba(74,222,128,' },
