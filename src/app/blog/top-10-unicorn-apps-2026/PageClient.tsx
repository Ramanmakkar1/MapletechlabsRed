        ...
        <section style={{ padding: 'var(--hero-top) 0 var(--section-y)', position: 'relative', overflow: 'hidden' }}>
          ...
          <div className="cb-container">
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 24 }}>
              ...
              <span className="reveal reveal-d1" style={{ fontSize: 13, color: 'var(--faint)' }}>March 13, 2026</span>
              ...
              <article>
                ...
                <div className="reveal" style={{ marginBottom: 56 }} id="greencart">
                  <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'flex-start', gap: 20, marginBottom: 20 }}>
                      <div style={{
                        width: 56, height: 56, borderRadius: 16, flexShrink: 0,
                        background: 'rgba(245,41,13,0.1)', border: '1px solid rgba(245,41,13,0.2)',
                        display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 28,
                      }}>🌿</div>
                      <div>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 4 }}>
                          <span style={{ fontSize: 12, color: 'var(--faint)', fontWeight: 700 }}>05</span>
                          <span style={{
                            fontSize: 11, padding: '3px 10px', borderRadius: 100,
                            background: 'rgba(245,41,13,0.12)', color: 'var(--brand)',
                            fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase',
                ...
                <div className="reveal" style={{ marginBottom: 64 }}>
                  <div style={{
                    ...
                    <h3 style={{
                      fontSize: 18, fontWeight: 600, color: 'var(--brand)',
                    ...
                    <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: 16 }}>
                      {[
                        ...
                        <li key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: 14 }}>
                          ...
                          <span style={{ fontSize: 15, color: 'var(--body)', lineHeight: 1.7 }}>{point}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
                    ...
                    <nav style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                      {apps.map(app => (
                        ...
                        >
                          ...
                          <span>{app.name}</span>
                          <span style={{ fontSize: 11, color: 'var(--faint)', marginLeft: 'auto' }}>{app.category}</span>
                        </a>
                      ))}
                    </nav>
                  </div>
