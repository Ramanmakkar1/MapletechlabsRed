...
const tocItems = [
  ...
  { id: 'mapletech-approach', label: 'Mapletech Approach', emoji: '🍁' },
...
export default function DigitalMarketingCostCanadaClient() {
                  ...
                  {[
                    ...
                    <div key={item.option} style={{
                      ...
                      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(280px, 100%), 1fr))', gap: 16, marginBottom: 16 }}>
                        <div>
                          <p style={{ fontSize: 12, fontWeight: 700, color: '#E11900', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 8 }}>Pros</p>
                          <p style={{ fontSize: 14, color: 'var(--muted)', lineHeight: 1.7, margin: 0 }}>{item.pros}</p>
                        </div>
                        <div>
                          <p style={{ fontSize: 12, fontWeight: 700, color: '#E11900', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 8 }}>Cons</p>
                ...
                <div className="reveal" style={{ marginBottom: 56 }} id="red-flags">
                  ...
                  <div style={{
                    ...
                    <div style={{ marginBottom: 24 }}>
                      <h3 style={{ fontSize: 16, fontWeight: 600, color: '#E11900', marginBottom: 12 }}>Too Cheap (Under $1,000/month for full-service)</h3>
                    ...
                    <div style={{ marginBottom: 24 }}>
                      <h3 style={{ fontSize: 16, fontWeight: 600, color: '#E11900', marginBottom: 12 }}>Guaranteed Rankings</h3>
                      <p style={{ fontSize: 15, color: 'var(--muted)', lineHeight: 1.8, margin: 0 }}>
                    ...
                    <div style={{ marginBottom: 24 }}>
                      <h3 style={{ fontSize: 16, fontWeight: 600, color: '#E11900', marginBottom: 12 }}>Long Lock-In Contracts</h3>
                      <p style={{ fontSize: 15, color: 'var(--muted)', lineHeight: 1.8, margin: 0 }}>
                    ...
                    <div>
                      <h3 style={{ fontSize: 16, fontWeight: 600, color: '#E11900', marginBottom: 12 }}>Overpriced (Paying for Brand Name, Not Results)</h3>
                      <p style={{ fontSize: 15, color: 'var(--muted)', lineHeight: 1.8, margin: 0 }}>
