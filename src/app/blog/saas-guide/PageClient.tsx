                ...
                <div className="reveal" style={{ marginBottom: 56 }} id="definition">
                    ...
                    <div style={{
                      ...
                      borderRadius: 16, padding: 24, marginBottom: 16,
                        ...
                        <p style={{ fontSize: 16, color: 'var(--ink)', margin: '0 0 8px', fontWeight: 600 }}>B2C SaaS (Business-to-Consumer):</p>
                    ...
                    <div style={{
                      ...
                      borderRadius: 16, padding: 24,
                        ...
                        <p style={{ fontSize: 15, color: 'var(--body)', margin: 0 }}>Think Salesforce, Slack, or niche industry tools like software specifically for dental clinics (lower volume, high price). <strong>This is where the real money is made.</strong></p>
                    </div>
                </div>
                ...
                <div className="reveal" style={{ marginBottom: 56 }} id="stack">
                    ...
                    <ul style={{ listStyle: 'none', padding: 0, margin: '0 0 24px', display: 'flex', flexDirection: 'column', gap: 16 }}>
                        <li style={{ display: 'flex', gap: 16 }}>
                            ...
                            <div>
                                <strong style={{ color: 'var(--ink)', display: 'block', marginBottom: 4 }}>Performance</strong>
                                <span style={{ color: 'var(--muted)', fontSize: 15, lineHeight: 1.6 }}>A Next.js and Node.js application will load instantly and handle thousands of concurrent users. No-code buckles under traffic.</span>
                            </div>
                        </li>
                        <li style={{ display: 'flex', gap: 16 }}>
                            <div style={{ width: 24, height: 24, borderRadius: '50%', background: 'transparent', border: '1px solid var(--brand)', color: 'var(--brand)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginTop: 4 }}>
                        ...
                        <li style={{ display: 'flex', gap: 16 }}>
                            ...
                            <div>
                                <strong style={{ color: 'var(--ink)', display: 'block', marginBottom: 4 }}>Security</strong>
                                <span style={{ color: 'var(--muted)', fontSize: 15, lineHeight: 1.6 }}>B2B clients demand rigorous security compliance (SOC2) that DIY builders cannot guarantee.</span>
                            </div>
                        </li>
                    </ul>
