...
const a = getArticle('build-saas-mvp-8-weeks')!;
const URL = `https://mapletechlabs.ca/blog/build-saas-mvp-8-weeks`;
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: canonicalUrl('/blog/build-saas-mvp-8-weeks') },
};
...
export default function Page() {
  return (
    <>
      ...
      <BreadcrumbSchema items={getBlogBreadcrumbs(a.title, 'build-saas-mvp-8-weeks')} />
