              ...
              <article>
                ...
                <div className="reveal" style={{ marginBottom: 56 }} id="cost-tiers">
                  ...
                  <div style={{
                    ...
                    <p style={{ fontSize: 28, fontWeight: 800, color: '#E11900', marginBottom: 16, letterSpacing: '-0.02em' }}>$75,000 - $200,000</p>
                    <p style={{ fontSize: 15, color: 'var(--muted)', lineHeight: 1.8 }}>
                  ...
                  <div style={{
                    ...
                    <p style={{ fontSize: 28, fontWeight: 800, color: '#E11900', marginBottom: 16, letterSpacing: '-0.02em' }}>$200,000 - $500,000+</p>
                    <p style={{ fontSize: 15, color: 'var(--muted)', lineHeight: 1.8 }}>
                ...
                <div className="reveal" style={{ marginBottom: 56 }} id="build-vs-buy">
                  ...
                  <p style={{ fontSize: 17, color: 'var(--muted)', lineHeight: 1.8, marginBottom: 32 }}>
                    <strong style={{ color: 'var(--ink)' }}>Use existing tools for:</strong> Payment processing (Stripe), authentication (Auth0 or Clerk), email delivery (Resend or SendGrid), file storage (AWS S3), search (Algolia), and analytics (Mixpanel). These services have teams of hundreds working on them full-time. You will never build a better version.
                  </p>
                  <p style={{ fontSize: 17, color: 'var(--muted)', lineHeight: 1.8, marginBottom: 20 }}>
                    <strong style={{ color: 'var(--ink)' }}>Build custom for:</strong> Your core business logic, proprietary algorithms, unique workflow engines, and any feature that directly represents your competitive advantage. This is where your development budget should be concentrated.
                  </p>
                  <div style={{
                    padding: '20px 24px', borderRadius: 16,
                    background: 'transparent', border: '1px solid var(--brand)',
                    ...
                    {[
                      ...
                      <div key={i} style={{
                        ...
                        <div style={{ flexShrink: 0, width: 80 }}>
                          <span style={{ fontSize: 11, fontWeight: 700, color: 'var(--brand)', textTransform: 'uppercase', letterSpacing: '0.08em' }}>{item.layer}</span>
                        </div>
                        <div>
                          <p style={{ fontSize: 15, fontWeight: 600, color: 'var(--ink)', margin: '0 0 4px' }}>{item.tech}</p>
                          <p style={{ fontSize: 14, color: 'var(--muted)', lineHeight: 1.7, margin: 0 }}>{item.why}</p>
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                <div className="reveal" style={{ marginBottom: 56 }} id="our-process">
                  ...
                  {[
                    ...
                    { phase: '02', name: 'Architecture', duration: '1-2 weeks', cost: '$5,000 - $12,000', color: '#E11900', desc: 'Database schema design, API architecture, infrastructure planning, and technology stack finalization. We create wireframes for every screen and define the data flow between components. This phase eliminates costly rewrites later.' },
                    { phase: '03', name: 'MVP Build', duration: '6-12 weeks', cost: '$20,000 - $60,000', color: '#E11900', desc: 'Iterative two-week sprints with demos after each cycle. We build the core product, integrate billing, deploy to staging, and conduct thorough QA. You have a working product in the hands of real users within three months.' },
                    { phase: '04', name: 'Scale', duration: '4-8 weeks', cost: '$15,000 - $40,000', color: '#E11900', desc: 'Performance optimization, load testing, security hardening, and infrastructure scaling. We add monitoring, alerting, and automated backups. Your product is now ready for aggressive customer acquisition.' },
                    { phase: '05', name: 'Optimize', duration: 'Ongoing', cost: '$3,000 - $10,000/mo', color: '#E11900', desc: 'Continuous improvement based on user analytics and feedback. Feature development, A/B testing, conversion optimization, and technical debt management. We become your fractional CTO and engineering team.' },
                  ].map((item, i) => (
                    <div key={i} style={{
