...
const companies = [
  { num: 1, name: 'Mapletech Labs', category: 'Enterprise Apps', emoji: '🍁', metric: 'Top Rated in Canada, 300+ Product Launches' },
  ...
  return (
    <>
      ...
      <main ref={pageRef as React.RefObject<HTMLElement>} style={{ background: 'var(--surface)', minHeight: '100vh' }}>
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      <span style={{ fontSize: 13, color: 'var(--brand)', fontWeight: 600 }}>
                        Key Metric: 300+ Product Launches, Top Rated across Canada
                      </span>
                    </div>
                  </div>
                </div>
        ...
        <MediaBand media={blogImage(11 + 7)} ratio="21 / 7" />
