...
const tocSections = [
  ...
  { id: 'hourly-rates', label: 'Canadian Developer Rates', emoji: '🇨🇦' },
...
export default function WebsiteCostCanadaClient() {
  ...
  return (
    <>
      ...
      <main ref={pageRef as React.RefObject<HTMLElement>} style={{ background: 'var(--surface)', minHeight: '100vh' }}>
              ...
              <article>
                ...
                <div className="reveal" style={{ marginBottom: 56 }} id="diy-vs-agency">
                  ...
                  <div style={{
                    ...
                    <h3 style={{ fontSize: 17, fontWeight: 600, color: '#E11900', margin: '0 0 10px' }}>DIY (Wix / Squarespace) — $0 - $500/year</h3>
                    <p style={{ fontSize: 15, color: 'var(--muted)', lineHeight: 1.7, margin: 0 }}>
                  ...
                  <div style={{
                    ...
                    <h3 style={{ fontSize: 17, fontWeight: 600, color: '#E11900', margin: '0 0 10px' }}>Agency (WordPress / Shopify) — $5,000 - $50,000</h3>
                    <p style={{ fontSize: 15, color: 'var(--muted)', lineHeight: 1.7, margin: 0 }}>
                ...
                <div className="reveal" style={{ marginBottom: 56 }} id="hourly-rates">
                  ...
                  <div style={{
                    ...
                    {[
                      { city: 'Toronto', range: '$120 - $180/hr', color: '#E11900' },
                      { city: 'Vancouver', range: '$110 - $170/hr', color: '#E11900' },
                      { city: 'Montreal', range: '$100 - $160/hr', color: '#E11900' },
                      { city: 'Edmonton', range: '$90 - $150/hr', color: '#E11900' },
                    ].map((city, i, arr) => (
                ...
                <div className="reveal" style={{ marginBottom: 56 }} id="hidden-costs">
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                    {[
                      { cost: 'Domain Registration', range: '$15 - $50/year', desc: 'Your .ca or .com domain name, renewed annually.' },
        ...
        <MediaBand media={blogImage(13 + 7)} ratio="21 / 7" />
