...
const a = getArticle('agentic-ai-in-production')!;
const URL = `https://mapletechlabs.ca/blog/agentic-ai-in-production`;
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: canonicalUrl('/blog/agentic-ai-in-production') },
};
...
export default function Page() {
  return (
    <>
      ...
      <BreadcrumbSchema items={getBlogBreadcrumbs(a.title, 'agentic-ai-in-production')} />
