...
const a = getArticle('custom-software-vs-off-the-shelf')!;
const URL = `https://mapletechlabs.ca/blog/custom-software-vs-off-the-shelf`;
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: canonicalUrl('/blog/custom-software-vs-off-the-shelf') },
};
...
export default function Page() {
  return (
    <>
      ...
      <BreadcrumbSchema items={getBlogBreadcrumbs(a.title, 'custom-software-vs-off-the-shelf')} />
