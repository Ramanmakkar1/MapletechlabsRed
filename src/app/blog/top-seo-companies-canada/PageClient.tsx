...
export default function TopSeoCompaniesCanadaClient() {
  ...
  return (
    <>
      ...
      <main ref={pageRef as React.RefObject<HTMLElement>} style={{ background: 'var(--surface)', minHeight: '100vh' }}>
        ...
        <section style={{ padding: 'var(--hero-top) 0 var(--section-y)', position: 'relative', overflow: 'hidden' }}>
          ...
          <div className="cb-container">
            ...
            <h1 className="reveal reveal-d2" style={{
              ...
              Top 10 SEO Companies in Canada (2026)
            </h1>
            ...
            <p className="reveal reveal-d3" style={{
              ...
              A comprehensive, data-driven ranking of the top 10 SEO agencies in Canada for 2026, featuring Mapletech Labs and other industry leaders driving serious organic growth.
            </p>
        ...
        <MediaBand media={blogImage(10 + 7)} ratio="21 / 7" />
