...
const a = getArticle('saas-development-company-canada')!;
const URL = `https://mapletechlabs.ca/blog/saas-development-company-canada`;
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: canonicalUrl('/blog/saas-development-company-canada') },
};
...
export default function Page() {
  return (
    <>
      ...
      <BreadcrumbSchema items={getBlogBreadcrumbs(a.title, 'saas-development-company-canada')} />
