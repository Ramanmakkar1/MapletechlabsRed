    ...
    <>
      ...
      <main style={{ background: 'var(--surface)', padding: '140px 40px 80px', minHeight: '60vh' }}>
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
          ...
          <h1 style={{ fontSize: 'clamp(2.5rem, 5vw, 4rem)', fontWeight: 600, color: 'var(--ink)', marginBottom: '24px' }}>Terms of Service</h1>
          ...
          <div style={{ fontSize: '16px', color: 'var(--body)', lineHeight: 1.9 }}>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 700, color: 'var(--ink)', marginTop: '48px', marginBottom: '16px' }}>1. Agreement to Terms</h2>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 700, color: 'var(--ink)', marginTop: '48px', marginBottom: '16px' }}>2. Services Description</h2>
            <p style={{ marginBottom: '20px' }}>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 700, color: 'var(--ink)', marginTop: '48px', marginBottom: '16px' }}>3. Intellectual Property Rights</h2>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 700, color: 'var(--ink)', marginTop: '48px', marginBottom: '16px' }}>4. Payment & Billing</h2>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 700, color: 'var(--ink)', marginTop: '48px', marginBottom: '16px' }}>5. Project Timeline & Changes</h2>
            <p style={{ marginBottom: '12px' }}>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 700, color: 'var(--ink)', marginTop: '48px', marginBottom: '16px' }}>6. Warranties & Limitations</h2>
            <p style={{ marginBottom: '12px' }}>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 700, color: 'var(--ink)', marginTop: '48px', marginBottom: '16px' }}>7. Confidentiality</h2>
            <p style={{ marginBottom: '20px' }}>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 700, color: 'var(--ink)', marginTop: '48px', marginBottom: '16px' }}>8. Termination</h2>
            <p style={{ marginBottom: '20px' }}>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 700, color: 'var(--ink)', marginTop: '48px', marginBottom: '16px' }}>9. Website Use License</h2>
            <p style={{ marginBottom: '20px' }}>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 700, color: 'var(--ink)', marginTop: '48px', marginBottom: '16px' }}>10. Disclaimer</h2>
            <p style={{ marginBottom: '20px' }}>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 700, color: 'var(--ink)', marginTop: '48px', marginBottom: '16px' }}>11. Modifications</h2>
            <p style={{ marginBottom: '20px' }}>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 700, color: 'var(--ink)', marginTop: '48px', marginBottom: '16px' }}>12. Governing Law</h2>
            <p style={{ marginBottom: '20px' }}>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 700, color: 'var(--ink)', marginTop: '48px', marginBottom: '16px' }}>13. Contact Information</h2>
            <p style={{ marginBottom: '20px' }}>
