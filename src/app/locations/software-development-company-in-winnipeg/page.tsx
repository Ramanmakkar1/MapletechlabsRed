...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Mapletech Labs delivers custom software development, mobile apps, AI solutions, and web development in Winnipeg, Manitoba. Get a free quote today.',
    url: 'https://mapletechlabs.ca/locations/software-development-company-in-winnipeg',
    type: 'website',
  },
  alternates: {
    canonical: canonicalUrl('/locations/software-development-company-in-winnipeg'),
  },
};
