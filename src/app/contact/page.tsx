...
export const metadata: Metadata = {
  ...
  description: 'Contact Mapletech Labs for a free project consultation. Custom software development company in Edmonton, Canada. Response within one working day.',
  openGraph: {
