    ...
    <>
      ...
      <main style={{ background: 'var(--surface)', padding: '140px 40px 80px', minHeight: '60vh' }}>
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
          ...
          <h1 style={{ fontSize: 'var(--fs-display)', fontWeight: 600, color: 'var(--ink)', marginBottom: '24px' }}>Privacy Policy</h1>
          ...
          <div style={{ fontSize: '16px', color: 'var(--body)', lineHeight: 1.9 }}>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 600, color: 'var(--ink)', marginTop: '48px', marginBottom: '16px' }}>3. How We Use Your Information</h2>
            <ul style={{ marginBottom: '20px', paddingLeft: '20px' }}>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 600, color: 'var(--ink)', marginTop: '48px', marginBottom: '16px' }}>4. Data Protection & Security</h2>
            <p style={{ marginBottom: '20px' }}>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 600, color: 'var(--ink)', marginTop: '48px', marginBottom: '16px' }}>5. GDPR & Privacy Regulations</h2>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 600, color: 'var(--ink)', marginTop: '48px', marginBottom: '16px' }}>6. Cookies & Tracking</h2>
            <p style={{ marginBottom: '20px' }}>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 600, color: 'var(--ink)', marginTop: '48px', marginBottom: '16px' }}>7. Data Retention</h2>
            <p style={{ marginBottom: '20px' }}>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 600, color: 'var(--ink)', marginTop: '48px', marginBottom: '16px' }}>8. Third-Party Services</h2>
            <p style={{ marginBottom: '20px' }}>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 600, color: 'var(--ink)', marginTop: '48px', marginBottom: '16px' }}>10. Updates to This Policy</h2>
            <p style={{ marginBottom: '20px' }}>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 600, color: 'var(--ink)', marginTop: '48px', marginBottom: '16px' }}>11. Contact Us</h2>
            <p style={{ marginBottom: '20px' }}>
