    ...
    <>
      ...
      <main style={{ background: 'var(--surface)', padding: '140px 40px 80px', minHeight: '60vh' }}>
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
          ...
          <h1 style={{ fontSize: 'clamp(2.5rem, 5vw, 4rem)', fontWeight: 600, color: 'var(--ink)', marginBottom: '24px' }}>Privacy Policy</h1>
          ...
          <div style={{ fontSize: '16px', color: 'var(--body)', lineHeight: 1.9 }}>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 700, color: 'var(--ink)', marginTop: '48px', marginBottom: '16px' }}>1. Introduction</h2>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 700, color: 'var(--ink)', marginTop: '48px', marginBottom: '16px' }}>2. Information We Collect</h2>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 700, color: 'var(--ink)', marginTop: '48px', marginBottom: '16px' }}>3. How We Use Your Information</h2>
            <ul style={{ marginBottom: '20px', paddingLeft: '20px' }}>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 700, color: 'var(--ink)', marginTop: '48px', marginBottom: '16px' }}>4. Data Protection & Security</h2>
            <p style={{ marginBottom: '20px' }}>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 700, color: 'var(--ink)', marginTop: '48px', marginBottom: '16px' }}>5. GDPR & Privacy Regulations</h2>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 700, color: 'var(--ink)', marginTop: '48px', marginBottom: '16px' }}>6. Cookies & Tracking</h2>
            <p style={{ marginBottom: '20px' }}>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 700, color: 'var(--ink)', marginTop: '48px', marginBottom: '16px' }}>7. Data Retention</h2>
            <p style={{ marginBottom: '20px' }}>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 700, color: 'var(--ink)', marginTop: '48px', marginBottom: '16px' }}>8. Third-Party Services</h2>
            <p style={{ marginBottom: '20px' }}>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 700, color: 'var(--ink)', marginTop: '48px', marginBottom: '16px' }}>9. Children's Privacy</h2>
            <p style={{ marginBottom: '20px' }}>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 700, color: 'var(--ink)', marginTop: '48px', marginBottom: '16px' }}>10. Updates to This Policy</h2>
            <p style={{ marginBottom: '20px' }}>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 700, color: 'var(--ink)', marginTop: '48px', marginBottom: '16px' }}>11. Contact Us</h2>
            <p style={{ marginBottom: '20px' }}>
              For privacy inquiries, data requests, or concerns, contact us at:<br />
              <strong>Email:</strong> <a href="mailto:privacy@mapletechlabs.ca" style={{ color: 'var(--brand)' }}>privacy@mapletechlabs.ca</a><br />
