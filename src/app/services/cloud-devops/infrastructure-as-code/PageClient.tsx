...
export default function PageClient() {
  return (
    <SubServicePageTemplate
      ...
      copy={{ badge: "CLOUD & DEVOPS", title: <>Infrastructure as Code That <span style={{ color: 'var(--brand)' }}>Eliminates Drift</span></>, desc: <>We turn your cloud infrastructure into version-controlled, reproducible, auditable code — so every environment is consistent and every change is reviewed.</> }}
      stats={stats}
      services={services}
      steps={steps}
      faqs={faqs}
