        ...
        <section ref={heroRef} style={{ minHeight: '60vh', display: 'flex', alignItems: 'center', paddingTop: 'var(--section-y)', paddingBottom: 'var(--section-y)' }}>
          <div className="cb-container">
            ...
            <div className="reveal" style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 28, fontSize: 12, color: 'var(--muted)' }}>
              ...
              <span>/</span>
              <Link href="/services/cloud-devops" style={{ color: 'var(--muted)', textDecoration: 'none' }}>Cloud & DevOps</Link>
              <span>/</span>
              <span style={{ color: 'var(--brand)' }}>Performance & Scaling</span>
            </div>
            ...
            <h1 className="reveal reveal-d2" style={{ fontSize: 'var(--fs-display)', fontWeight: 600, letterSpacing: '-0.04em', lineHeight: 1.05, marginBottom: 24, maxWidth: 800 }}>
              Performance Engineering for <span style={{ color: 'var(--brand)' }}>Any Scale</span>
            </h1>
            <p className="reveal reveal-d3" style={{ fontSize: 18, color: 'var(--muted)', lineHeight: 1.7, maxWidth: 600, marginBottom: 40 }}>We find and fix the bottlenecks that slow your product down — from database queries to global CDN strategy — so you can handle any traffic without breaking a sweat.</p>
