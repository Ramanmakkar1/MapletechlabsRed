...
export default function PageClient() {
  return (
    <SubServicePageTemplate
      ...
      copy={{ badge: "CLOUD & DEVOPS", title: <>Performance Engineering for <span style={{ color: 'var(--brand)' }}>Any Scale</span></>, desc: <>We find and fix the bottlenecks that slow your product down — from database queries to global CDN strategy — so you can handle any traffic without breaking a sweat.</> }}
      stats={stats}
      services={services}
      steps={steps}
      faqs={faqs}
