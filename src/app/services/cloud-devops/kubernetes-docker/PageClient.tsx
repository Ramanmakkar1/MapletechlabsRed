...
export default function PageClient() {
  return (
    <SubServicePageTemplate
      ...
      copy={{ badge: "CLOUD & DEVOPS", title: <>Kubernetes & Docker That <span style={{ color: 'var(--brand)' }}>Scales Effortlessly</span></>, desc: <>Production-grade containerisation and orchestration that reduces infrastructure costs, eliminates deployment headaches, and handles any traffic spike.</> }}
      stats={stats}
      services={services}
      steps={steps}
      faqs={faqs}
