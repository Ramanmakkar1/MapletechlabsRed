...
export default function PageClient() {
  return (
    <SubServicePageTemplate
      ...
      copy={{ badge: "CLOUD & DEVOPS", title: <>CI/CD Pipelines That <span style={{ color: 'var(--brand)' }}>Ship Faster, Safer</span></>, desc: <>Automated build, test, and deployment pipelines that eliminate manual processes, catch issues early, and let your team ship with confidence every day.</> }}
      stats={stats}
      services={services}
      steps={steps}
      faqs={faqs}
