    ...
    <>
      ...
      <main style={{ background: 'var(--surface)', color: 'var(--ink)', paddingTop: 80 }}>
        ...
        <section ref={heroRef} style={{ position: 'relative', overflow: 'hidden', padding: 'clamp(60px, 8vw, 100px) 0 clamp(60px, 8vw, 120px)', borderBottom: '1px solid var(--line)' }}>
          ...
          {/* Glow */}
          <div style={{ position: 'absolute', bottom: '10%', right: '5%', width: 700, height: 600, background: 'radial-gradient(ellipse,rgba(245,41,13,0.08) 0%,transparent 65%)', filter: 'blur(70px)', pointerEvents: 'none' }} />
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 480px), 1fr))', gap: 'clamp(24px, 5vw, 80px)', alignItems: 'center' }}>
              ...
              <div>
                ...
                <div className="reveal" style={{ display: 'inline-flex', alignItems: 'center', gap: 10, background: 'rgba(245,41,13,0.08)', border: '1px solid rgba(245,41,13,0.2)', borderRadius: 100, padding: '8px 20px', marginBottom: 32 }}>
                  ...
                  <span style={{ fontSize: 11, fontWeight: 700, color: 'var(--brand)', letterSpacing: '0.12em', textTransform: 'uppercase' }}>Cloud &amp; DevOps</span>
                </div>

                <h1 className="reveal reveal-d1" style={{ fontSize: 'clamp(3rem,6vw,6rem)', fontWeight: 600, color: 'var(--ink)', letterSpacing: '-0.04em', lineHeight: 1.0, margin: '0 0 28px' }}>
                  Infrastructure That<br /><span style={{ color: 'var(--brand)' }}>Never Sleeps.</span>
                </h1>

                <p className="reveal reveal-d2" style={{ fontSize: 18, color: 'var(--body)', lineHeight: 1.75, maxWidth: 620, margin: '0 0 44px' }}>
                ...
                <div className="reveal reveal-d3" style={{ display: 'flex', gap: 14, flexWrap: 'wrap' }}>
                  ...
                  <Link href="/contact" style={{ display: 'inline-flex', alignItems: 'center', height: 56, padding: '0 32px', borderRadius: 100, border: '1px solid var(--line)', color: 'var(--ink)', fontSize: 14, fontWeight: 500, textDecoration: 'none', transition: '0.3s' }}
          ...
          <div className="cb-container">
            <div className="reveal" style={{ marginBottom: 64 }}>
              ...
              <h2 style={{ fontSize: 'clamp(2.2rem,4vw,4rem)', fontWeight: 600, color: 'var(--ink)', letterSpacing: '-0.04em', lineHeight: 1.05, margin: 0 }}>
                Resilient by Design.<br /><span style={{ color: 'var(--faint)' }}>Automated by Default.</span>
              </h2>
            </div>
        ...
        <section ref={processRef} className="section-padding" style={{ borderBottom: '1px solid var(--line)' }}>
          <div className="cb-container">
            <div className="reveal" style={{ marginBottom: 80 }}>
              ...
              <h2 style={{ fontSize: 'clamp(2.2rem,4vw,4rem)', fontWeight: 600, color: 'var(--ink)', letterSpacing: '-0.04em', lineHeight: 1.05, margin: 0 }}>
                From Audit<br /><span style={{ color: 'var(--faint)' }}>to Optimised.</span>
              </h2>
            </div>
        ...
        <section ref={industriesRef} className="section-padding" style={{ borderBottom: '1px solid var(--line)' }}>
          <div className="cb-container">
            <div className="reveal" style={{ marginBottom: 64 }}>
              ...
              <h2 style={{ fontSize: 'clamp(2.2rem,4vw,4rem)', fontWeight: 600, color: 'var(--ink)', letterSpacing: '-0.04em', lineHeight: 1.05, margin: 0 }}>
                Infrastructure That<br /><span style={{ color: 'var(--faint)' }}>Powers Every Sector.</span>
              </h2>
            </div>
            <div className="reveal reveal-d1" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 280px), 1fr))', gap: 20 }}>
        ...
        <section ref={ctaRef} style={{ padding: 'clamp(60px, 8vw, 120px) 0', position: 'relative', overflow: 'hidden', textAlign: 'center' }}>
          ...
          <div className="cb-container" style={{ position: 'relative', zIndex: 1 }}>
            <div className="reveal" style={{ fontSize: 11, fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--faint)', marginBottom: 24 }}>Ready to Scale?</div>
            <h2 className="reveal reveal-d1" style={{ fontSize: 'clamp(2.5rem,5vw,5.5rem)', fontWeight: 600, color: 'var(--ink)', letterSpacing: '-0.04em', lineHeight: 1.0, margin: '0 0 28px' }}>
              Ready to Scale Your<br /><span style={{ color: 'var(--brand)' }}>Infrastructure?</span>
            </h2>
            <TrustBadges compact />
            <p className="reveal reveal-d2" style={{ fontSize: 18, color: 'var(--muted)', maxWidth: 500, margin: '0 auto 48px', lineHeight: 1.7 }}>
            ...
            <div className="reveal reveal-d3" style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap', marginBottom: 48 }}>
              ...
              <Link href="/contact" style={{ display: 'inline-flex', alignItems: 'center', height: 60, padding: '0 40px', borderRadius: 100, border: '1px solid var(--line)', color: 'var(--ink)', fontSize: 15, fontWeight: 500, textDecoration: 'none', transition: '0.3s' }}
                onMouseEnter={e => e.currentTarget.style.borderColor = 'var(--line-strong)'}
                onMouseLeave={e => e.currentTarget.style.borderColor = 'var(--line)'}>
