  ...
  return (
    <>
      ...
      <main style={{ background: 'var(--surface)', color: 'var(--ink)', fontFamily: 'inherit' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 480px), 1fr))', gap: 'clamp(24px, 5vw, 60px)', alignItems: 'center' }}>
              <div>
                <div className="reveal" style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 28, fontSize: 12, color: 'var(--muted)' }}>
                  ...
                  <span>/</span>
                  <Link href="/services/wordpress-cms" style={{ color: 'var(--muted)', textDecoration: 'none' }}>WordPress & CMS</Link>
                  <span>/</span>
                  <span style={{ color: 'var(--brand)' }}>Site Speed Optimisation</span>
                </div>
                <div className="reveal reveal-d1" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '6px 16px', borderRadius: 100, background: 'rgba(245,41,13,0.08)', border: '1px solid rgba(245,41,13,0.2)', marginBottom: 24 }}>
                  ...
                  <span style={{ fontSize: 12, fontWeight: 600, color: 'var(--brand)', letterSpacing: '0.05em' }}>WORDPRESS & CMS</span>
                </div>
                <h1 className="reveal reveal-d2" style={{ fontSize: 'var(--fs-display)', fontWeight: 600, letterSpacing: '-0.04em', lineHeight: 1.05, marginBottom: 24, maxWidth: 800 }}>
                  WordPress Site Speed <span style={{ color: 'var(--brand)' }}>Optimisation</span>
                </h1>
                <p className="reveal reveal-d3" style={{ fontSize: 18, color: 'var(--muted)', lineHeight: 1.7, maxWidth: 600, marginBottom: 40 }}>Transform a slow, frustrating WordPress site into a 90+ Lighthouse score performer — passing Core Web Vitals, ranking higher, and converting more.</p>
        ...
        <MediaBand
          media={serviceMedia['wordpress-cms'] ?? defaultMedia}
        />
