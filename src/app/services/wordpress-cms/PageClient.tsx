      ...
      <main style={{ background: 'var(--surface)', color: 'var(--ink)', paddingTop: 80 }}>
        ...
        <section ref={s2} className="section-padding" style={{ borderBottom: '1px solid var(--line)' }}>
          <div className="cb-container">
            ...
            <h2 className="reveal reveal-d1" style={{ fontSize: 'clamp(2rem,3.5vw,3rem)', fontWeight: 600, letterSpacing: '-0.03em', margin: '0 0 16px' }}>WordPress & CMS Services</h2>
        ...
        <section ref={s3} className="section-padding" style={{ borderBottom: '1px solid var(--line)' }}>
          <div className="cb-container">
            ...
            <h2 className="reveal reveal-d1" style={{ fontSize: 'clamp(2rem,3.5vw,3rem)', fontWeight: 600, letterSpacing: '-0.03em', margin: '0 0 60px' }}>Our Website Build Process</h2>
        ...
        <section ref={s4} className="section-padding" style={{ borderBottom: '1px solid var(--line)' }}>
          <div className="cb-container">
            ...
            <h2 className="reveal reveal-d1" style={{ fontSize: 'clamp(2rem,3.5vw,3rem)', fontWeight: 600, letterSpacing: '-0.03em', margin: '0 0 48px' }}>Sites That Perform</h2>
