      ...
      <main style={{ background: 'var(--surface)', color: 'var(--ink)', paddingTop: 'var(--section-y)' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 480px), 1fr))', gap: 'clamp(24px, 5vw, 80px)', alignItems: 'center' }}>
              ...
              <div>
                <div className="reveal" style={{ display: 'inline-flex', alignItems: 'center', gap: 10, background: 'rgba(245,41,13,0.08)', border: '1px solid rgba(245,41,13,0.2)', borderRadius: 100, padding: '8px 20px', marginBottom: 32 }}>
                  ...
                  <span style={{ fontSize: 11, fontWeight: 700, color: 'var(--brand)', letterSpacing: '0.12em', textTransform: 'uppercase' }}>WordPress & CMS</span>
                </div>
                <h1 className="reveal reveal-d1" style={{ fontSize: 'var(--fs-display)', fontWeight: 600, color: 'var(--ink)', letterSpacing: '-0.04em', lineHeight: 1.0, margin: '0 0 24px', maxWidth: 700 }}>
                  We Build Sites That <span style={{ color: 'var(--brand)' }}>Sell.</span>
                </h1>
        ...
        <section ref={s2} className="section-padding" style={{ borderBottom: '1px solid var(--line)' }}>
          <div className="cb-container">
            ...
            <h2 className="reveal reveal-d1" style={{ fontSize: 'var(--fs-h2)', fontWeight: 600, letterSpacing: '-0.03em', margin: '0 0 16px' }}>WordPress & CMS Services</h2>
            <p className="reveal reveal-d2" style={{ fontSize: 16, color: 'var(--muted)', maxWidth: 520, margin: '0 0 56px', lineHeight: 1.7 }}>Fast, secure and editable — everything from marketing sites to headless e-commerce.</p>
            {/* Service Cards */}
        ...
        <section ref={s3} className="section-padding" style={{ borderBottom: '1px solid var(--line)' }}>
          <div className="cb-container">
            ...
            <h2 className="reveal reveal-d1" style={{ fontSize: 'var(--fs-h2)', fontWeight: 600, letterSpacing: '-0.03em', margin: '0 0 60px' }}>Our Website Build Process</h2>
        ...
        <section ref={s4} className="section-padding" style={{ borderBottom: '1px solid var(--line)' }}>
          <div className="cb-container">
            ...
            <h2 className="reveal reveal-d1" style={{ fontSize: 'var(--fs-h2)', fontWeight: 600, letterSpacing: '-0.03em', margin: '0 0 48px' }}>Sites That Perform</h2>
              ...
              {[
                ...
                <Link key={ind.title} href={ind.href} style={{ textDecoration: 'none' }}>
                  <div style={{ padding: '36px 32px', border: '1px solid var(--line)', borderRadius: 28, background: 'var(--surface-alt)', position: 'relative', overflow: 'hidden', transition: 'all 0.35s ease', height: '100%' }}
                    ...
                    <h3 style={{ fontSize: 'var(--fs-h4)', fontWeight: 600, color: 'var(--ink)', letterSpacing: '-0.02em', marginBottom: 12 }}>{ind.title}</h3>
        ...
        <section ref={s6} className="section-padding">
          <div className="cb-container" style={{ textAlign: 'center' }}>
            ...
            <h2 className="reveal reveal-d1" style={{ fontSize: 'var(--fs-h2)', fontWeight: 600, letterSpacing: '-0.04em', lineHeight: 1.05, margin: '0 0 24px' }}>
              Ready to Build Your <span style={{ color: 'var(--brand)' }}>Website?</span>
            </h2>
