    ...
    <>
      ...
      <main style={{ background: 'var(--surface)', color: 'var(--ink)', fontFamily: 'inherit' }}>
        ...
        <section ref={heroRef} style={{ minHeight: '60vh', display: 'flex', alignItems: 'center', paddingTop: 'var(--section-y)', paddingBottom: 'var(--section-y)' }}>
          <div className="cb-container">
            ...
            <div className="reveal" style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 28, fontSize: 12, color: 'var(--muted)' }}>
              ...
              <span>/</span>
              <span style={{ color: 'var(--brand)' }}>Motion & Video Branding</span>
            </div>
            ...
            <h1 className="reveal reveal-d2" style={{ fontSize: 'var(--fs-display)', fontWeight: 600, letterSpacing: '-0.04em', lineHeight: 1.05, marginBottom: 24, maxWidth: 800 }}>
              Motion That Makes Brands <span style={{ color: 'var(--brand)' }}>Come Alive</span>
            </h1>
            <p className="reveal reveal-d3" style={{ fontSize: 18, color: 'var(--muted)', lineHeight: 1.7, maxWidth: 600, marginBottom: 40 }}>Broadcast-quality motion branding — from logo animations and Lottie web assets to explainer videos and social motion templates — that gives your brand a dynamic visual presence across every screen.</p>
        ...
        <section ref={s4} style={{ padding: 'var(--section-y) 0', textAlign: 'center' }}>
          <div className="cb-container">
            <h2 className="reveal" style={{ fontSize: 'var(--fs-h2)', fontWeight: 600, letterSpacing: '-0.04em', marginBottom: 20 }}>Ready to Animate Your Brand?</h2>
            <p className="reveal reveal-d1" style={{ fontSize: 18, color: 'var(--muted)', marginBottom: 40, maxWidth: 500, margin: '0 auto 40px' }}>Let's bring your brand to life with motion design that captivates audiences across every screen.</p>
