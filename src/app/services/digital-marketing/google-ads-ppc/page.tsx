...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://www.mapletechlabs.com/services/digital-marketing/google-ads-ppc',
    type: 'website',
  },
  alternates: {
    canonical: 'https://www.mapletechlabs.com/services/digital-marketing/google-ads-ppc',
  },
};
