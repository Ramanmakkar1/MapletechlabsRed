          ...
          <div className="cb-container">
            <div className="reveal" style={{ textAlign: 'center', maxWidth: 640, margin: '0 auto' }}>
              ...
              <p style={{ fontSize: 16, color: 'var(--muted)', lineHeight: 1.7, marginBottom: 40 }}>
                We build custom marketing strategies based on your industry, goals, and budget. Share your objectives and we&apos;ll deliver a tailored proposal within 48 hours.
              </p>
