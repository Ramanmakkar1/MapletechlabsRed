      ...
      <main style={{ background: 'var(--surface)', color: 'var(--ink)', fontFamily: 'inherit' }}>
        ...
        <section ref={heroRef} style={{ minHeight: '60vh', display: 'flex', alignItems: 'center', paddingTop: 'var(--section-y)', paddingBottom: 'var(--section-y)' }}>
          <div className="cb-container">
            ...
            <div className="reveal" style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 28, fontSize: 12, color: 'var(--muted)' }}>
              ...
              <span>/</span>
              <Link href="/services/ai-ml" style={{ color: 'var(--muted)', textDecoration: 'none' }}>AI & Machine Learning</Link>
              <span>/</span>
              <span style={{ color: 'var(--brand)' }}>LLM Integration</span>
            </div>
            <div className="reveal reveal-d1" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '6px 16px', borderRadius: 100, background: 'rgba(245,41,13,0.08)', border: '1px solid rgba(245,41,13,0.2)', marginBottom: 24 }}>
              ...
              <span style={{ fontSize: 12, fontWeight: 600, color: 'var(--brand)', letterSpacing: '0.05em' }}>AI & MACHINE LEARNING</span>
            </div>
            <h1 className="reveal reveal-d2" style={{ fontSize: 'var(--fs-display)', fontWeight: 600, letterSpacing: '-0.04em', lineHeight: 1.05, marginBottom: 24, maxWidth: 800 }}>
              LLM Integration <span style={{ color: 'var(--brand)' }}>Experts</span>
            </h1>
            <p className="reveal reveal-d3" style={{ fontSize: 18, color: 'var(--muted)', lineHeight: 1.7, maxWidth: 600, marginBottom: 40 }}>We integrate GPT-4, Claude, Gemini, and open-source LLMs into your products and workflows — from simple API wrappers to production-grade RAG pipelines and fine-tuned custom models.</p>
        ...
        <section ref={s1} style={{ padding: 'var(--section-y) 0' }}>
          <div className="cb-container">
            <div className="reveal" style={{ textAlign: 'center', marginBottom: 64 }}>
              ...
              <h2 style={{ fontSize: 'var(--fs-h2)', fontWeight: 600, letterSpacing: '-0.03em' }}>Our LLM Capabilities</h2>
            </div>
        ...
        <section ref={s4} style={{ padding: 'var(--section-y) 0', textAlign: 'center' }}>
          <div className="cb-container">
            ...
            <p className="reveal reveal-d1" style={{ fontSize: 18, color: 'var(--muted)', marginBottom: 40, maxWidth: 500, margin: '0 auto 40px' }}>Let's discuss your LLM project and build something great together.</p>
