...
export default function PageClient() {
  return (
    <SubServicePageTemplate
      ...
      copy={{ badge: "GAME DEVELOPMENT", title: <>Unreal Engine 5 with <span style={{ color: 'var(--brand)' }}>AAA Visuals</span></>, desc: <>We build cinematic-quality games, simulations, and visualisations in Unreal Engine 5 — leveraging Lumen, Nanite, and Chaos to deliver experiences that redefine what real-time looks like.</> }}
      stats={stats}
      services={services}
      steps={steps}
      faqs={faqs}
