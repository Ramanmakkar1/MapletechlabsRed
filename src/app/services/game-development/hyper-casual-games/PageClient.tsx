...
export default function PageClient() {
  return (
    <SubServicePageTemplate
      ...
      copy={{ badge: "GAME DEVELOPMENT", title: <>Hyper-Casual Games Built for <span style={{ color: 'var(--brand)' }}>Viral Scale</span></>, desc: <>We prototype, test, and publish hyper-casual games at speed — from 3-day prototypes to CPI-validated full builds designed for the App Store and Play Store top charts.</> }}
      stats={stats}
      services={services}
      steps={steps}
      faqs={faqs}
