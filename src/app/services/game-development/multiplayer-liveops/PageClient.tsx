...
export default function PageClient() {
  return (
    <SubServicePageTemplate
      ...
      name="Multiplayer & LiveOps Development"
      copy={{ badge: "GAME DEVELOPMENT", title: <>Multiplayer &amp; <span style={{ color: 'var(--brand)' }}>LiveOps at Scale</span></>, desc: <>We build real-time multiplayer infrastructure and the LiveOps systems that keep players engaged and spending — from netcode architecture through seasonal events and anti-cheat.</> }}
      stats={stats}
      services={services}
      steps={steps}
      faqs={faqs}
