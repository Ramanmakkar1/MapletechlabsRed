...
export default function PageClient() {
  return (
    <SubServicePageTemplate
      ...
      copy={{ badge: "GAME DEVELOPMENT", title: <>Expert <span style={{ color: 'var(--brand)' }}>Unity Game Development</span></>, desc: <>80+ Unity projects across mobile, PC, and console. We bring deep C# expertise, clean architecture, and full-pipeline knowledge from prototype through platform certification.</> }}
      stats={stats}
      services={services}
      steps={steps}
      faqs={faqs}
