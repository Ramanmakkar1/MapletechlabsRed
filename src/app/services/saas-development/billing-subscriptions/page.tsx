...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://www.mapletechlabs.com/services/saas-development/billing-subscriptions',
    type: 'website',
  },
  alternates: {
    canonical: 'https://www.mapletechlabs.com/services/saas-development/billing-subscriptions',
  },
};
