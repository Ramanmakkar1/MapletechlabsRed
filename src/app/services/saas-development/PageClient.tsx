      ...
      <main style={{ background: 'var(--surface)', color: 'var(--ink)', paddingTop: 'var(--section-y)' }}>
        ...
        <section ref={s2} className="section-padding" style={{ borderBottom: '1px solid var(--line)' }}>
          <div className="cb-container">
            ...
            <h2 className="reveal reveal-d1" style={{ fontSize: 'var(--fs-h2)', fontWeight: 600, letterSpacing: '-0.03em', margin: '0 0 16px' }}>Full-Stack SaaS Engineering</h2>
        ...
        <section ref={s3} className="section-padding" style={{ borderBottom: '1px solid var(--line)' }}>
          <div className="cb-container">
            ...
            <h2 className="reveal reveal-d1" style={{ fontSize: 'var(--fs-h2)', fontWeight: 600, letterSpacing: '-0.03em', margin: '0 0 60px' }}>Our SaaS Build Process</h2>
        ...
        <section ref={s4} className="section-padding" style={{ borderBottom: '1px solid var(--line)' }}>
          <div className="cb-container">
            ...
            <h2 className="reveal reveal-d1" style={{ fontSize: 'var(--fs-h2)', fontWeight: 600, letterSpacing: '-0.03em', margin: '0 0 48px' }}>SaaS Built to Last</h2>
