...
export default function PageClient() {
  return (
    <SubServicePageTemplate
      ...
      copy={{ badge: "BLOCKCHAIN & WEB3", title: <>Crypto Wallets Built for <span style={{ color: 'var(--brand)' }}>Security</span></>, desc: <>We build production-grade custodial and non-custodial wallets — from HD key management and multi-chain support to hardware wallet integration and DeFi connectivity — trusted by 1M+ users across 15+ wallets.</> }}
      stats={stats}
      services={services}
      steps={steps}
      faqs={faqs}
