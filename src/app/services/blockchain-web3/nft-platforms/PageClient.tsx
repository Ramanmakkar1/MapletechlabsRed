      ...
      <main style={{ background: 'var(--surface)', color: 'var(--ink)', fontFamily: 'inherit' }}>
        ...
        <section ref={heroRef} style={{ minHeight: '60vh', display: 'flex', alignItems: 'center', paddingTop: 'var(--section-y)', paddingBottom: 'var(--section-y)' }}>
          <div className="cb-container">
            ...
            <div className="reveal" style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 28, fontSize: 12, color: 'var(--muted)' }}>
              ...
              <span>/</span>
              <span style={{ color: 'var(--brand)' }}>NFT Platform Development</span>
            </div>
            ...
            <h1 className="reveal reveal-d2" style={{ fontSize: 'var(--fs-display)', fontWeight: 600, letterSpacing: '-0.04em', lineHeight: 1.05, marginBottom: 24, maxWidth: 800 }}>
              NFT Platforms Built to <span style={{ color: 'var(--brand)' }}>Launch</span>
            </h1>
            <p className="reveal reveal-d3" style={{ fontSize: 18, color: 'var(--muted)', lineHeight: 1.7, maxWidth: 600, marginBottom: 40 }}>We build gas-optimized NFT minting contracts, custom marketplaces, and royalty systems from strategy through launch — 500K+ NFTs minted across 30+ platforms we've shipped.</p>
        ...
        <section ref={s4} style={{ padding: 'var(--section-y) 0', textAlign: 'center' }}>
          <div className="cb-container">
            ...
            <p className="reveal reveal-d1" style={{ fontSize: 18, color: 'var(--muted)', marginBottom: 40, maxWidth: 500, margin: '0 auto 40px' }}>Let's discuss your NFT platform and build something great together.</p>
