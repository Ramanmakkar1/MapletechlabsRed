  ...
  return (
    <>
      ...
      <main style={{ background: 'var(--surface)', color: 'var(--ink)', paddingTop: 'var(--section-y)' }}>
        ...
        <section ref={heroRef} className="section-padding" style={{ position: 'relative', overflow: 'hidden', minHeight: '90vh', display: 'flex', alignItems: 'center' }}>
          ...
          <div className="cb-container" style={{ position: 'relative', zIndex: 1, textAlign: 'center', maxWidth: 860, margin: '0 auto' }}>
            ...
            <h1 className="reveal" style={{ fontSize: 'var(--fs-display)', fontWeight: 600, lineHeight: 1.1, marginBottom: '1.5rem', letterSpacing: '-0.02em' }}>
              We Engineer Logistics That <span style={{ color: 'var(--brand)' }}>Never Stops.</span>
            </h1>
        ...
        <MediaBand
          media={industryMedia['logistics'] ?? defaultMedia}
        />
        <section ref={s1} className="section-padding">
          <div className="cb-container">
            <div className="reveal" style={{ textAlign: 'center', marginBottom: '3rem' }}>
              <h2 style={{ fontSize: 'var(--fs-h2)', fontWeight: 600, marginBottom: '1rem' }}>Key Challenges We Solve</h2>
              <p style={{ color: 'var(--body)', fontSize: '1.1rem' }}>Modern supply chains demand real-time intelligence at every node.</p>
            </div>
        ...
        <section ref={s2} className="section-padding">
          <div className="cb-container">
            <div className="reveal" style={{ textAlign: 'center', marginBottom: '3rem' }}>
              ...
              <p style={{ color: 'var(--body)', fontSize: '1.1rem' }}>From depot to doorstep, we engineer every link in the chain.</p>
            </div>
          ...
          <div className="cb-container">
            <div className="reveal" style={{ border: '1px solid rgba(245,41,13,0.15)', borderRadius: 32, background: 'rgba(245,41,13,0.03)', padding: 'clamp(1.5rem, 4vw, 3rem)', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(400px, 100%), 1fr))', gap: 'clamp(1.5rem, 4vw, 3rem)', alignItems: 'center' }}>
              <div>
                ...
                <div style={{ fontSize: '1.1rem', fontWeight: 700, color: 'var(--brand)', marginBottom: '0.5rem' }}>LogiCore</div>
                <h3 style={{ fontSize: 'var(--fs-h3)', fontWeight: 600, marginBottom: '1rem', lineHeight: 1.2 }}>50M shipments/year, 30% fuel savings, 12min avg delivery improvement</h3>
                <p style={{ color: 'var(--body)', lineHeight: 1.7 }}>We replaced their legacy dispatch system with a real-time ML platform — live GPS feeds, dynamic re-routing, and a new driver app adopted across 2,000+ vehicles.</p>
              </div>
              <div>
                <blockquote style={{ borderLeft: '3px solid #f5290d', paddingLeft: '1.5rem', margin: 0 }}>
                  ...
                  <cite style={{ fontSize: '0.9rem', color: 'var(--faint)', fontStyle: 'normal' }}>— COO, LogiCore</cite>
                </blockquote>
              </div>
            </div>
          </div>
        ...
        <section ref={s4} className="section-padding">
          <div className="cb-container">
            <div className="reveal" style={{ textAlign: 'center', marginBottom: '3rem' }}>
              ...
              <p style={{ color: 'var(--body)', fontSize: '1.1rem' }}>Proven technologies for high-throughput logistics operations.</p>
            </div>
        ...
        <section ref={s5} className="section-padding">
          <div className="cb-container">
            <div className="reveal" style={{ textAlign: 'center', marginBottom: '3rem' }}>
              ...
              <p style={{ color: 'var(--body)', fontSize: '1.1rem' }}>We understand that in logistics, every minute counts.</p>
            </div>
            <div className="reveal" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem' }}>
              {[
          ...
          <div className="cb-container">
            <div className="reveal" style={{ textAlign: 'center', maxWidth: 700, margin: '0 auto' }}>
              <h2 style={{ fontSize: 'var(--fs-h2)', fontWeight: 600, lineHeight: 1.15, marginBottom: '1.5rem' }}>
                Build Your <span style={{ color: 'var(--brand)' }}>Logistics Platform.</span>
              </h2>
