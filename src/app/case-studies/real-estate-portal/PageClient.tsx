        ...
        <section style={{ padding: 'clamp(100px, 12vw, 140px) 0 clamp(40px, 5vw, 64px)', position: 'relative', overflow: 'hidden' }}>
          ...
          <div className="cb-container">
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginTop: 32, marginBottom: 16 }}>
              ...
              <span className="reveal reveal-d1" style={{ fontSize: 13, color: 'var(--faint)' }}>PropConnect Canada &middot; Toronto</span>
            </div>
            ...
            <figure className="media media--lg fade" style={{ aspectRatio: '16 / 9', margin: '0 0 48px' }}>
              <Image src={caseStudyMedia['real-estate-portal'].src} alt={caseStudyMedia['real-estate-portal'].alt} fill priority sizes="(max-width: 1400px) 100vw, 1320px" style={{ objectFit: 'cover' }} />
            </figure>
          </div>
        </section>
        ...
        <section style={{ paddingBottom: 'var(--section-y)', borderTop: '1px solid var(--line)' }}>
          <div className="cb-container" style={{ paddingTop: 'var(--section-y)' }}>
            <div className="reveal" style={{
              ...
              <div>
                <p style={{ fontSize: 15, fontWeight: 600, color: 'var(--ink)', margin: '0 0 4px' }}>CEO</p>
                <p style={{ fontSize: 13, color: 'var(--muted)', margin: 0 }}>PropConnect Canada</p>
              </div>
            </div>
          </div>
        </section>
