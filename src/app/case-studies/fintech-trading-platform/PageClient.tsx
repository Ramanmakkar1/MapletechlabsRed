        ...
        <section style={{ padding: 'clamp(100px, 12vw, 140px) 0 clamp(40px, 5vw, 64px)', position: 'relative', overflow: 'hidden' }}>
          ...
          <div className="cb-container">
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginTop: 32, marginBottom: 16 }}>
              ...
              <span className="reveal reveal-d1" style={{ fontSize: 13, color: 'rgba(255,255,255,0.3)' }}>Fintech Client &middot; Toronto</span>
            </div>
        ...
        <section style={{ paddingBottom: 'clamp(48px, 6vw, 80px)', borderTop: '1px solid rgba(255,255,255,0.07)' }}>
          <div className="cb-container" style={{ paddingTop: 'clamp(48px, 6vw, 80px)' }}>
            <div className="reveal" style={{
              ...
              {[
                { title: 'Challenge', text: 'A fast-growing Canadian fintech needed a platform capable of processing high-frequency trades in real time while meeting strict regulatory requirements and scaling to meet surging user demand.' },
                { title: 'Solution', text: 'Mapletech Labs designed and built a cloud-native trading engine with AI-driven analytics, event-driven microservices, and an institutional-grade security layer — delivered in under 6 months.' },
          ...
          <div className="cb-container" style={{ paddingTop: 'clamp(48px, 6vw, 80px)' }}>
            <div className="reveal" style={{
              ...
              <p style={{
                ...
                &ldquo;Mapletech Labs didn&apos;t just build us a trading platform — they gave us a competitive advantage. The speed, reliability, and intelligence baked into the system have fundamentally changed how our traders operate. We went from firefighting infrastructure issues to focusing entirely on growth.&rdquo;
              </p>
              <div>
                <p style={{ fontSize: 15, fontWeight: 600, color: '#fff', margin: '0 0 4px' }}>Chief Technology Officer</p>
                <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.4)', margin: 0 }}>Leading Canadian Fintech</p>
              </div>
            </div>
          </div>
        </section>
