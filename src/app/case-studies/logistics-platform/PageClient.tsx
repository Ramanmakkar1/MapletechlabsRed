        ...
        <section style={{ padding: '140px 0 64px', position: 'relative', overflow: 'hidden' }}>
          ...
          <div className="cb-container">
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginTop: 32, marginBottom: 16 }}>
              ...
              <span className="reveal reveal-d1" style={{ fontSize: 13, color: 'rgba(255,255,255,0.3)' }}>Logistics Client &middot; Vancouver</span>
            </div>
        ...
        <section style={{ paddingBottom: 80, borderTop: '1px solid rgba(255,255,255,0.07)' }}>
          <div className="cb-container" style={{ paddingTop: 80 }}>
            <div className="reveal" style={{
              ...
              <div>
                <p style={{ fontSize: 15, fontWeight: 600, color: '#fff', margin: '0 0 4px' }}>VP of Operations</p>
                <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.4)', margin: 0 }}>Leading Vancouver Logistics Company</p>
              </div>
            </div>
          </div>
        </section>
