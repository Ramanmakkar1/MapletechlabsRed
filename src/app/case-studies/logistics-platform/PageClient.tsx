  ...
  return (
    <>
      ...
      <main ref={pageRef as React.RefObject<HTMLElement>} style={{ background: 'var(--surface)', minHeight: '100vh' }}>
        ...
        <section style={{ padding: 'clamp(100px, 12vw, 140px) 0 clamp(40px, 5vw, 64px)', position: 'relative', overflow: 'hidden' }}>
          ...
          <div className="cb-container">
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginTop: 32, marginBottom: 16 }}>
              ...
              <span className="reveal reveal-d1" style={{ fontSize: 13, color: 'var(--faint)' }}>Logistics Client &middot; Vancouver</span>
            </div>
            ...
            <figure className="media media--lg fade" style={{ aspectRatio: '16 / 9', margin: '0 0 48px' }}>
              <Image src={caseStudyMedia['logistics-platform'].src} alt={caseStudyMedia['logistics-platform'].alt} fill priority sizes="(max-width: 1400px) 100vw, 1320px" style={{ objectFit: 'cover' }} />
            </figure>
          </div>
        </section>
        ...
        <section style={{ paddingBottom: 'var(--section-y)', borderTop: '1px solid var(--line)' }}>
          <div className="cb-container" style={{ paddingTop: 'var(--section-y)' }}>
            <div className="reveal" style={{
              ...
              {[
                { title: 'Challenge', text: 'A Vancouver-based logistics company managing a fleet of 500+ vehicles had no real-time visibility into operations. Routes were planned manually, fuel costs were spiraling, and on-time delivery rates had dropped below 80%.' },
                { title: 'Solution', text: 'Mapletech Labs built a full-stack logistics platform with IoT device integration for real-time fleet tracking, a TensorFlow-based route optimization engine, and a MapBox-powered operations dashboard — delivered in 4 months.' },
        ...
        <MediaBand media={humanPick('logistics-platform')} ratio="21 / 8" />
