  ...
  return (
    <>
      ...
      <main ref={pageRef as React.RefObject<HTMLElement>} style={{ background: 'var(--surface)', minHeight: '100vh' }}>
        ...
        <MediaBand media={humanPick('healthcare-telehealth')} ratio="21 / 8" />
        ...
        <section style={{ paddingBottom: 'var(--section-y)', borderTop: '1px solid var(--line)' }}>
          <div className="cb-container" style={{ paddingTop: 'var(--section-y)' }}>
            <div className="reveal" style={{
              ...
              <div>
                <p style={{ fontSize: 15, fontWeight: 600, color: 'var(--ink)', margin: '0 0 4px' }}>Chief Medical Officer</p>
                <p style={{ fontSize: 13, color: 'var(--muted)', margin: 0 }}>Leading Calgary Healthcare Network</p>
              </div>
            </div>
          </div>
        </section>
