        ...
        <section style={{ padding: 'clamp(100px, 12vw, 140px) 0 clamp(40px, 5vw, 64px)', position: 'relative', overflow: 'hidden' }}>
          ...
          <div className="cb-container">
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginTop: 32, marginBottom: 16 }}>
              ...
              <span className="reveal reveal-d1" style={{ fontSize: 13, color: 'rgba(255,255,255,0.3)' }}>Healthcare Client &middot; Calgary</span>
            </div>
        ...
        <section style={{ paddingBottom: 'clamp(48px, 6vw, 80px)', borderTop: '1px solid rgba(255,255,255,0.07)' }}>
          <div className="cb-container" style={{ paddingTop: 'clamp(48px, 6vw, 80px)' }}>
            <div className="reveal" style={{
              ...
              {[
                { title: 'Challenge', text: 'A Calgary-based healthcare network needed to rapidly deploy a telehealth solution during COVID-19 while meeting strict HIPAA and PIPEDA compliance requirements and integrating with existing Electronic Health Record systems.' },
                { title: 'Solution', text: 'Mapletech Labs built a cross-platform mobile app with React Native, leveraging WebRTC for encrypted video consultations and HL7 FHIR for seamless EHR integration — delivered in 14 weeks.' },
          ...
          <div className="cb-container">
            <div className="reveal" style={{ maxWidth: 760 }}>
              ...
              <p style={{ fontSize: 17, color: 'rgba(255,255,255,0.6)', lineHeight: 1.8, marginBottom: 20 }}>
                When the pandemic hit, our client — a multi-location healthcare network in Calgary — found themselves scrambling to provide remote care. Their existing workflows were entirely paper-based and in-person. Patients were cancelling appointments, specialists were idle, and the organization was losing revenue while failing to meet patient needs.
              </p>
              <p style={{ fontSize: 17, color: 'rgba(255,255,255,0.6)', lineHeight: 1.8, marginBottom: 20 }}>
                The compliance landscape made this particularly challenging. The platform needed to satisfy HIPAA requirements for Protected Health Information (PHI), align with PIPEDA for Canadian data privacy, and support end-to-end encryption for all video, audio, and messaging channels. There was zero tolerance for data breaches in this space.
              </p>
          ...
          <div className="cb-container" style={{ paddingTop: 'clamp(48px, 6vw, 80px)' }}>
            <div className="reveal" style={{
              ...
              <p style={{
                ...
                &ldquo;We went from zero telehealth capability to serving thousands of patients per week in under four months. Mapletech Labs understood our compliance constraints from day one and delivered a platform that our clinicians actually enjoy using. The EHR integration alone saved us hundreds of hours of manual data entry.&rdquo;
              </p>
              <div>
                <p style={{ fontSize: 15, fontWeight: 600, color: '#fff', margin: '0 0 4px' }}>Chief Medical Officer</p>
                <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.4)', margin: 0 }}>Leading Calgary Healthcare Network</p>
              </div>
            </div>
          </div>
        </section>
